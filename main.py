...
#This program takes a (hardcoded) BLHELI_32 music string and converts it to rttl for Blue Jay
#Look to the bottom for an example and to switch your own music.
#UserInput Lines are marked with "##INPUT######""
...
def convert_string_to_rttl_print(prefix,source_Melody):
...
print("ESC1")
convert_string_to_rttl_print(insert_number(prefix,1), esc1)
print("ESC2")
convert_string_to_rttl_print(insert_number(prefix,2),esc2)
print("ESC3")
convert_string_to_rttl_print(insert_number(prefix,3),esc3)
print("ESC4")
convert_string_to_rttl_print(insert_number(prefix,4),esc4)